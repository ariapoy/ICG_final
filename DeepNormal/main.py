...
parser.add_argument('--save_name', dest ='save_name', default='test', help='Name of the save image')
...
#Write result
# cv2.imwrite(args.save_path +'{0}-normalmap.png'.format(args.save_name), final)
cv2.imwrite('{0}-normalmap.png'.format(args.save_name), final)
print('result normal map saved in: ' + '{0}-normalmap.png'.format(args.save_name))
